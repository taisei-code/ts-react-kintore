...
function App() {
  ...
  const today1 = new DayMemories(
    "1",
    "2023/10/10",
    [record1, record2, record3]
  )

  const today2 = new DayMemories(
    "2",
    "2023/10/11",
    [record1, record2]
  )

  const today3 = new DayMemories(
    "3",
    "2023/10/12",
    [record1]
  )
  ...
  const [records, setRecords] = useState([ today1, today2, today3 ])
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
          ...
          <ModalContent>
            ...
            <ModalBody pb={6}>
              ...
              <Box mb={4}>
                <Text mb={2}>種目</Text>
                <Select placeholder="種目を選択" value={menuInput} onChange={(e) => menuChange(e.target.value)}>
              ...
              <Box mb={4}>
                <Text mb={2}>重量</Text>
                <Select placeholder="重さを選択" value={weightInput} onChange={(e) => weightChange(e.target.value)} >
            ...
            <ModalFooter>
              <Button colorScheme="blue" mr={3} isDisabled={dateInput == "" || menuInput == "" || weightInput == "" || dateError != "" || menuError != "" || weightError != ""}>
                登録
              </Button>
